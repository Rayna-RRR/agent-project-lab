...
This repository is currently an early v0.1 implementation. `lab init`, `lab agents check`, and `lab skill new` work; the remaining commands are intentionally stubbed.
...
- Command stubs for `skill review` and `log add`.
